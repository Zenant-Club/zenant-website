    ...
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#FEF2E2]/95 backdrop-blur-sm shadow-sm">
      <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-4 flex items-center justify-between">
        ...
        <a
          ...
          className="hidden md:flex items-center gap-3 text-white px-9 py-3.5 rounded-full font-lora font-bold whatsapp-cta-btn"
      ...
      >
        <nav className="flex flex-col px-6 py-4 gap-1">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="mt-3 flex items-center justify-center gap-3 text-white px-9 py-3.5 rounded-full font-lora font-bold whatsapp-cta-btn"
